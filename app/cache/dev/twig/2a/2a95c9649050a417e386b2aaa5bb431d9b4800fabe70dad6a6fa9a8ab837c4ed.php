...
/* TFTpersonneBundle:Match:ajoutermatch.html.twig */
class __TwigTemplate_aa869260147496b578395f8e4b93ed95a93ebffa06d2020b48d628b51a18f77e extends Twig_Template
{
...
\t\t\t
                        ...
                        <li class=\"icn_new_article\"><a>New Stadium</a></li>
\t\t\t<li class=\"icn_categories\"><a>Delete Stadium</a></li>
\t\t\t<li class=\"icn_categories\"><a>Edit Stadium</a></li>
                        <li class=\"icn_categories\"><a>extraire Stadium</a></li>
...
\t\t\t\t\t\t\t<label>Resultat</label>
                                  ";
        // line 208
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "resultat", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
                                                 </fieldset>
\t\t\t\t\t\t<fieldset>
\t\t\t\t\t\t\t<label>Stade</label>
                                  ";
        // line 212
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "idstade", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "\t\t\t\t\t\t</fieldset>
...
\t\t\t\t\t\t\t<label>Resultat</label>
                                  ";
        // line 216
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "types", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "      </fieldset> 
                                                  <fieldset>
\t\t\t\t\t\t\t<label>Date</label>
                  ";
        // line 219
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "dateMatch", array()), 'widget', array("attr" => array("class" => "dat")));
        echo "                                          </fieldset>
...
";
    ...
    {
        return "TFTpersonneBundle:Match:ajoutermatch.html.twig";
    }
    ...
    {
        return array (  312 => 227,  308 => 226,  298 => 219,  292 => 216,  285 => 212,  278 => 208,  269 => 202,  258 => 194,  254 => 193,  237 => 178,  234 => 177,  226 => 240,  224 => 177,  167 => 122,  138 => 94,  131 => 90,  122 => 84,  118 => 83,  74 => 42,  70 => 41,  66 => 40,  62 => 39,  54 => 34,  20 => 2,);
    }
}
/* {# empty Twig template #}*/
/* <!doctype html>*/
...
/*                                                  <fieldset>*/
/* 							<label>Resultat</label>*/
/*                                   {{ form_widget(f.resultat, { 'attr': {'class': 'bar'} }) }}*/
/*                                                  </fieldset>*/
/* 						<fieldset>*/
/* 							<label>Stade</label>*/
/*                                   {{ form_widget(f.idstade, { 'attr': {'class': 'bar'} }) }}						</fieldset>*/
/* 						</fieldset><div class="clear"></div>*/
/*                                                   <fieldset>*/
/* 							<label>Resultat</label>*/
/*                                   {{ form_widget(f.types, { 'attr': {'class': 'bar'} }) }}      </fieldset> */
/*                                                   <fieldset>*/
/* 							<label>Date</label>*/
/*                   {{ form_widget(f.dateMatch, { 'attr': {'class': 'dat'} }) }}                                          </fieldset>*/
/* */
/* 				</div>*/
/* */
/* */
