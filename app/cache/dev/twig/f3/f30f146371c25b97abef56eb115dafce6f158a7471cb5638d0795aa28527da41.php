...
/* TFTpersonneBundle:Pronostic:ajoutJeu.html.twig */
class __TwigTemplate_18c002e19cc89c3a84d379b224beb20c52ed62856b8779c0b86bb6794ab64775 extends Twig_Template
{
...
\t\t\t\t\t\t\t<label>Le nom du joueur 1</label>
\t\t\t\t\t\t\t                                                        ";
        // line 193
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "idmatches1", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
\t\t\t\t\t\t\t<label>Le nom du joueur 2</label>
                                                                                                        ";
        // line 199
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "idmatches2", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
\t\t\t\t\t\t\t                                                        ";
        // line 205
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "idmatches3", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
\t\t\t\t\t\t\t<label>Le nom du joueur 2</label>
                                                                                                        ";
        // line 211
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "idmatches4", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
\t\t\t\t\t\t\t                                                        ";
        // line 216
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "idmatches5", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
\t\t\t\t\t\t\t<label>Le nom du joueur 2</label>
                                                                                                        ";
        // line 222
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "idmatches6", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
\t\t\t\t\t\t\t                                                        ";
        // line 227
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "idmatches7", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
\t\t\t\t\t\t\t<label>Le nom du joueur 2</label>
                                                                                                        ";
        // line 233
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "idmatches8", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
\t\t\t\t\t\t\t                                                        ";
        // line 238
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "idmatches9", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
\t\t\t\t\t\t\t<label>Le nom du joueur 2</label>
                                                                                                        ";
        // line 244
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "idmatches10", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
";
    ...
    {
        return "TFTpersonneBundle:Pronostic:ajoutJeu.html.twig";
    }
    ...
    {
        return array (  364 => 252,  360 => 251,  350 => 244,  341 => 238,  333 => 233,  324 => 227,  316 => 222,  307 => 216,  299 => 211,  290 => 205,  281 => 199,  272 => 193,  255 => 178,  252 => 177,  244 => 265,  242 => 177,  200 => 138,  183 => 124,  179 => 122,  173 => 117,  169 => 116,  165 => 115,  161 => 114,  138 => 94,  131 => 90,  122 => 84,  118 => 83,  74 => 42,  70 => 41,  66 => 40,  62 => 39,  54 => 34,  20 => 2,);
    }
}
/* {# empty Twig template #}*/
/* <!doctype html>*/
...
/* 						<fieldset style="width:48%; float:left; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Le nom du joueur 1</label>*/
/* 							                                                        {{ form_widget(f.idmatches1, { 'attr': {'class': 'bar'} }) }}*/
/*                                                        */
/* */
/* 						</fieldset>*/
/* 						<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Le nom du joueur 2</label>*/
/*                                                                                                         {{ form_widget(f.idmatches2, { 'attr': {'class': 'bar'} }) }}*/
/*  */
/*                                                 </fieldset>*/
/*                                                                                                         */
/*                                  <fieldset style="width:48%; float:left; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Le nom du joueur 1</label>*/
/* 							                                                        {{ form_widget(f.idmatches3, { 'attr': {'class': 'bar'} }) }}*/
/*                                                        */
/* */
/* 						</fieldset>*/
/* 						<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Le nom du joueur 2</label>*/
/*                                                                                                         {{ form_widget(f.idmatches4, { 'attr': {'class': 'bar'} }) }}*/
/*  */
/*                                                 </fieldset>*/
/*                                                                                                         <fieldset style="width:48%; float:left; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Le nom du joueur 1</label>*/
/* 							                                                        {{ form_widget(f.idmatches5, { 'attr': {'class': 'bar'} }) }}*/
/*                                                        */
/* */
/* 						</fieldset>*/
/* 						<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Le nom du joueur 2</label>*/
/*                                                                                                         {{ form_widget(f.idmatches6, { 'attr': {'class': 'bar'} }) }}*/
/*  */
/*                                                 </fieldset>*/
/*                                                                                                         <fieldset style="width:48%; float:left; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Le nom du joueur 1</label>*/
/* 							                                                        {{ form_widget(f.idmatches7, { 'attr': {'class': 'bar'} }) }}*/
/*                                                        */
/* */
/* 						</fieldset>*/
/* 						<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Le nom du joueur 2</label>*/
/*                                                                                                         {{ form_widget(f.idmatches8, { 'attr': {'class': 'bar'} }) }}*/
/*  */
/*                                                 </fieldset>*/
/*                                                                                                         <fieldset style="width:48%; float:left; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Le nom du joueur 1</label>*/
/* 							                                                        {{ form_widget(f.idmatches9, { 'attr': {'class': 'bar'} }) }}*/
/*                                                        */
/* */
/* 						</fieldset>*/
/* 						<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Le nom du joueur 2</label>*/
/*                                                                                                         {{ form_widget(f.idmatches10, { 'attr': {'class': 'bar'} }) }}*/
/*  */
/*                                                 </fieldset>*/
/*                                                 */
/* */
