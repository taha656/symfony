...
/* TFTpersonneBundle:Resultat:modifierresultat.html.twig */
class __TwigTemplate_f59e726c982624d20a9dc1ce6ae1b7d8ed9da9b71ede08aaeb40a827330eac73 extends Twig_Template
{
...
\t\t\t<header><h3>Post New Result</h3></header>
...
\t\t\t\t\t\t\t                                                        ";
        // line 214
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "idjoueur1", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
                                                        ";
        // line 215
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "idjoueur1", array()), 'widget', array("attr" => array("class" => "bar")));
...
\t\t\t\t\t\t\t<label>Le nom du joueur 2</label>
                                                                                                        ";
        // line 220
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "idjoueur2", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
\t\t\t\t\t\t\t                                                        ";
        // line 226
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "set1joueur1", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
\t\t\t\t\t\t\t<label>Set 1</label>
                                                                                                        ";
        // line 232
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "set1joueur2", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
\t\t\t\t\t\t\t                                                        ";
        // line 237
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "set2joueur1", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
\t\t\t\t\t\t\t<label>Set 2</label>
                                                                                                        ";
        // line 243
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "set2joueur2", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
\t\t\t\t\t\t\t                                                        ";
        // line 249
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "set3joueur1", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
\t\t\t\t\t\t\t<label>Set 3</label>
                                                                                                        ";
        // line 255
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "set3joueur2", array()), 'widget', array("attr" => array("class" => "bar")));
        echo "
...
";
    ...
    {
        return "TFTpersonneBundle:Resultat:modifierresultat.html.twig";
    }
    ...
    {
        return array (  365 => 275,  360 => 273,  339 => 255,  330 => 249,  321 => 243,  312 => 237,  304 => 232,  295 => 226,  286 => 220,  278 => 215,  274 => 214,  255 => 197,  252 => 196,  244 => 287,  242 => 196,  183 => 139,  154 => 111,  147 => 107,  138 => 101,  134 => 100,  90 => 59,  86 => 58,  82 => 57,  78 => 56,  70 => 51,  20 => 3,);
    }
}
/* {# empty Twig template #}*/
/* {# empty Twig template #}*/
...
/*                                     <fieldset style="width:48%; float:left; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Le nom du joueur 1</label>*/
/* 							                                                        {{ form_widget(f.idjoueur1, { 'attr': {'class': 'bar'} }) }}*/
/*                                                         {{ form_widget(f.idjoueur1, { 'attr': {'class': 'bar'} }) }}*/
/* */
/* 						</fieldset>*/
/* 						<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Le nom du joueur 2</label>*/
/*                                                                                                         {{ form_widget(f.idjoueur2, { 'attr': {'class': 'bar'} }) }}*/
/* */
/*                                                 </fieldset>*/
/*                                                    */
/*                                                    <fieldset style="width:48%; float:left; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Set 1</label>*/
/* 							                                                        {{ form_widget(f.set1joueur1, { 'attr': {'class': 'bar'} }) }}*/
/* */
/* 						</fieldset>*/
/*                                                         */
/* 						<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Set 1</label>*/
/*                                                                                                         {{ form_widget(f.set1joueur2, { 'attr': {'class': 'bar'} }) }}*/
/* */
/*                                                 </fieldset>     */
/*                                                                                                                                                            <fieldset style="width:48%; float:left; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Set 2</label>*/
/* 							                                                        {{ form_widget(f.set2joueur1, { 'attr': {'class': 'bar'} }) }}*/
/* */
/* 						</fieldset>*/
/*                                                         */
/* 						<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Set 2</label>*/
/*                                                                                                         {{ form_widget(f.set2joueur2, { 'attr': {'class': 'bar'} }) }}*/
/* */
/*                                                 </fieldset>                                                   */
/* */
/*                                                                                                                                                            <fieldset style="width:48%; float:left; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Set 3</label>*/
/* 							                                                        {{ form_widget(f.set3joueur1, { 'attr': {'class': 'bar'} }) }}*/
/* */
/* 						</fieldset>*/
/*                                                         */
/* 						<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->*/
/* 							<label>Set 3</label>*/
/*                                                                                                         {{ form_widget(f.set3joueur2, { 'attr': {'class': 'bar'} }) }}*/
/* */
/*                                                 </fieldset>                                                   */
/* */
/*                                                                                                         */
