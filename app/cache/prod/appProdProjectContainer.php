...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'os', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\TFT\\personneBundle\\Entity'))), 'TFT\\personneBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('TFTpersonneBundle' => 'TFT\\personneBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_76f90344093c73b56a2c1d40eb4c2de3bd5936429e484f761a7f667e3dda8f9b');
        return $instance;
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('asma.tlich@esprit.tn' => 'TFT_Registration'), 'resetting' => array('asma.tlich@esprit.tn' => 'TFT_Resetting'))));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('asma.tlich');
        $a->setPassword('asma22257006');
        $a->setAuthMode('login');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_host' => NULL,
            'mailer_user' => 'asma.tlich',
            'mailer_password' => 'asma22257006',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'asma.tlich',
            'swiftmailer.mailer.default.transport.smtp.password' => 'asma22257006',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'asma.tlich@esprit.tn' => 'TFT_Registration',
            ),
            ...
            'fos_user.resetting.email.from_email' => array(
                'asma.tlich@esprit.tn' => 'TFT_Resetting',
            ),
